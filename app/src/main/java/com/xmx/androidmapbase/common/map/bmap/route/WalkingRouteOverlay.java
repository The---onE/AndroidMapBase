package com.xmx.androidmapbase.common.map.bmap.route;
...
public class WalkingRouteOverlay extends OverlayManager {
    ...
    public WalkingRouteLine.WalkingStep getWalkingStep(Marker marker) {
        for (Overlay mMarker : mOverlayList) {
            if (mMarker instanceof Marker && mMarker.equals(marker)) {
                if (marker.getExtraInfo() != null) {
                    return mRouteLine.getAllStep().
                            get(marker.getExtraInfo().getInt("index"));
                }
            }
        }
        return null;
