...
public class ZhUtil {
     ...
     * 简体到繁体的映射表
     */
    private static SettingManager s2tSetting;
    /**
     * 繁体到简体的映射表
     */
    private static SettingManager t2sSetting;

    /**
     * 初始化简体到繁体的映射表
     */
    public static void initS2T() {
        s2tSetting = new SettingManager(S2T_PATH, "utf8", false);
    }
    ...
    public static void initT2S() {
        t2sSetting = new SettingManager(T2S_PATH, "utf8", false);
    }
