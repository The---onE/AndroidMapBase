 ...
 * @author xiaoleilu
 */
public class ConsistentHashingManager<T> {
    /**
     ...
     * @param nodes            节点对象
     */
    public ConsistentHashingManager(int numberOfReplicas, Collection<T> nodes) {
     ...
     * @param nodes            节点对象
     */
    public ConsistentHashingManager(HashFunc hashFunc, int numberOfReplicas, Collection<T> nodes) {
        this.numberOfReplicas = numberOfReplicas;
