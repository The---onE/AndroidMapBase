...
public final class ConfigManager {
     ...
     */
    public ConfigManager(String pathBaseClassLoader) {
        URL url = ConfigManager.class.getClassLoader().getResource(pathBaseClassLoader);
     ...
     * @param clazz 基准类
     */
    public ConfigManager(String path, Class<?> clazz) {
