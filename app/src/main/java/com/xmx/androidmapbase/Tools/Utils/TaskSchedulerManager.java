 ...
 */
public class TaskSchedulerManager extends Timer {
    private static Logger logger = LoggerFactory.getLogger(TaskSchedulerManager.class);

    public TaskSchedulerManager(boolean isDeamon) {
        //daemon进程
        super(true);
    }
     ...
     * @return 任务调度对象
     */
    public static TaskSchedulerManager newInstance(boolean isDaemon) {
        return new TaskSchedulerManager(isDaemon);
    }
