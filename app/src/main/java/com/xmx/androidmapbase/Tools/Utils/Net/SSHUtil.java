package com.xmx.androidmapbase.Tools.Utils.Net;

import com.xmx.androidmapbase.Tools.Utils.Exceptions.ConnException;
import com.xmx.androidmapbase.Tools.Utils.StrUtil;
...
public class SSHUtil {
    ...
    synchronized public static Session openSession(String sshHost, int sshPort, String sshUser, String sshPass) {
        if (StrUtil.isBlank(sshHost) || sshPort < 0 || StrUtil.isBlank(sshUser) || StrUtil.isBlank(sshPass))
            return null;
