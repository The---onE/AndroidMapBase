...
import com.xmx.androidmapbase.Tools.Utils.Exceptions.SettingException;
import com.xmx.androidmapbase.Tools.Utils.Net.URLUtil;
 ...
 * @author xiaoleilu
 */
public class SettingManager extends HashMap<String, String> {
     ...
     */
    public SettingManager(Charset charset, boolean isUseVariable) {
     ...
     * @param isUseVariable       是否使用变量
     */
    public SettingManager(String pathBaseClassLoader, String charset, boolean isUseVariable) {
     ...
     * @param isUseVariable 是否使用变量
     */
    public SettingManager(File configFile, String charset, boolean isUseVariable) {
        if (configFile == null) {
     ...
     * @param isUseVariable 是否使用变量
     */
    public SettingManager(String path, Class<?> clazz, String charset, boolean isUseVariable) {
     ...
     * @param isUseVariable 是否使用变量
     */
    public SettingManager(URL url, String charset, boolean isUseVariable) {
        if (url == null) {
